...
public class Agenda {
     ...
     * @param contacto objeto contacto que se añade a la agenda
     * @return el objeto contacto añadido
     * @throws ContactoRepetidoException si hay un contacto repetido salta la excepción
     */
