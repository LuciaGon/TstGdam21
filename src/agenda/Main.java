/*
 * Grupo        :	1∫ de GDAM Tarde
 * Alumno       :	LucÌa Gonz·lez Carmona
 * Numero Exp   :	7253
 * Fecha			09/06/2022
 */
...
public class Main {
    ...
    public static void main(String[] args) {
       Contacto c1,c2,c3;
        ...
        Contacto contacto2 = new Contacto("rmsces2122@gmail.com","555 555 552","Ram√≥n");
        //Contacto contacto2 = new Contacto(null,null,null);
        System.out.println("-- A√±adiendo los contactos ---");
            try {
        ...
        System.out.println("-- Listando los contactos a√±adidos ---");
